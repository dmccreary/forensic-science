---
title: Forensic Entomology and Decomposition Analysis
description: Stages of decomposition, blowfly lifecycle, ADH/ADD calculations, minimum post-mortem interval estimation, insect succession ecology, and environmental variables.
...
## The Blowfly Lifecycle: A Biological Clock
...
## Accumulated Degree Hours (ADH) and the mPMI Calculation
...
**Accumulated Degree Days (ADD)** is the same concept using daily averages:
\[
\text{ADD} = \sum_{\text{days}} \left( T_{\text{avg}} - T_{\text{base}} \right)
\]
...
<iframe src="../../sims/adh-mpmi-calculator/main.html" width="100%" height="520px" scrolling="no"></iframe>

<details markdown="1">
<summary>ADH and mPMI Calculator MicroSim</summary>
Type: microsim
...
## Environmental Variables in PMI Estimation
...
??? question "Challenge: mPMI Calculation"
    ...
    **Answer:**
    ADD/day = daily average − base temp (2°C):
    Day 1: 16, Day 2: 18, Day 3: 20, Day 4: 17, Day 5: 15, Day 6: 19
    Total ADD = 16 + 18 + 20 + 17 + 15 + 19 = **105 ADD**
