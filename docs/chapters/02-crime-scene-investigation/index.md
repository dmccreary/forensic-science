---
title: Crime Scene Investigation and Evidence Collection
description: Systematic protocols for securing, documenting, searching, and processing crime scenes using the Seven S's methodology and chain-of-custody standards.
generated_by: claude skill chapter-content-generator
date: 2026-06-01 18:46:03
version: 0.08
---
...
1. **List** the Seven S's of Crime Scene Investigation in correct procedural order.
2. **Distinguish** between primary and secondary crime scenes and explain how each is processed differently.
3. **Apply** triangulation measurement to produce a scaled crime scene sketch.
4. **Select** the appropriate search pattern given the terrain, personnel available, and evidence type.
5. **Demonstrate** proper evidence collection and packaging procedures, including chain-of-custody documentation.
...
1. Chain of Custody
2. Seven S's of Crime Scene
3. Crime Scene Perimeter Security
4. Primary vs Secondary Scenes
5. Crime Scene Documentation
6. Crime Scene Photography
7. Crime Scene Sketching
8. Scaled Sketch Techniques
9. Triangulation Measurement
10. Evidence Search Patterns
11. Grid Search Pattern
12. Spiral Search Pattern
13. Zone Search Pattern
14. Evidence Identification
15. Evidence Collection Protocols
16. Evidence Packaging Materials
17. Druggist Fold Technique
18. Biohazard Evidence Containers
19. Physical Evidence Types
20. Trace Evidence
...
<iframe src="../../sims/search-pattern-selector/main.html" width="100%" height="520px" scrolling="no"></iframe>

<details markdown="1">
<summary>Evidence Search Pattern Selector MicroSim</summary>
Type: microsim
...
1. Fold the bottom third up
2. Fold the top third down, overlapping the first fold
3. Fold the left third to the right
4. Fold the right third to the left, creating a secure, self-sealing packet
...
<iframe src="../../sims/evidence-packaging-guide/main.html" width="100%" height="500px" scrolling="no"></iframe>

<details markdown="1">
<summary>Evidence Packaging Decision Guide Interactive Infographic</summary>
Type: infographic
...
<iframe src="../../sims/chain-of-custody-flow/main.html" width="100%" height="500px" scrolling="no"></iframe>

<details markdown="1">
<summary>Chain of Custody Flow Interactive Diagram</summary>
Type: workflow
...
!!! mascot-encourage "You've Got This, Investigator"
    ![Trace giving thumbs up](../../img/mascot/encouraging.png){ class="mascot-admonition-img"}
...
??? question "Challenge: What Went Wrong?"
