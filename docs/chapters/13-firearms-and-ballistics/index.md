---
title: Firearms, Ballistics, and Toolmark Examination
description: Internal/external/terminal ballistics, rifling and striation analysis, GSR testing, toolmark comparison, serial number restoration, and comparison microscopy.
...
1. **Explain** how rifling imprints class and individual characteristics on fired bullets and cartridge cases.
2. **Identify** the key physical evidence from a firearm discharge: bullet, cartridge case, and GSR.
3. **Distinguish** between entrance and exit wounds and explain the wound morphology differences.
4. **Describe** how the comparison microscope is used to link a recovered bullet to a specific firearm.
5. **Explain** the acid etching technique for serial number restoration.
...
2. Rifling in Firearms
3. Lands and Grooves
4. Breech Face Markings
5. Firing Pin Impressions
6. Ejector Marks
7. External Ballistics
8. Bullet Trajectory Calculation
9. Terminal Ballistics
10. Entrance vs Exit Wounds
11. Wound Morphology
12. Ricochet Analysis
13. Gunshot Residue (GSR)
14. Modified Griess Test
15. Toolmark Analysis
16. Compression Marks
17. Sliding Marks
18. Serial Number Restoration
19. Acid Etching Technique
...
**Rifling characteristics** include:
- **Twist direction**: clockwise (right-hand twist, most common) or counterclockwise (left-hand twist)
- **Rate of twist**: how quickly the spiral completes one full rotation (e.g., 1:10 = one complete turn in 10 inches of barrel length)
- **Number of lands and grooves**: typically 4–8 depending on the manufacturer and caliber
- **Width and depth** of lands and grooves
...
**Entrance wounds** from handguns and rifles typically show:
- A round or oval hole with an **abrasion ring** (friction burn from the bullet's passage) around the margin
- At contact and near-contact range: **stippling** (gunpowder particle tattooing of the skin) and **soot** (unburned carbon deposition) may be present
- Relatively contained wound margins

**Exit wounds** typically show:
- Irregular, larger, stellate (star-shaped) or ragged margins
- Lack of abrasion ring
- Everted (outward-projecting) wound edges
- No stippling or soot (the muzzle gases have dissipated by exit)
...
GSR deposits on:
- The hands and wrists of the shooter (particularly the web between thumb and index finger)
- The face and hair of the shooter
- Clothing and surfaces near the discharge point
...
<iframe src="../../sims/ballistic-pathway/main.html" width="100%" height="520px" scrolling="no"></iframe>

<details markdown="1">
<summary>Firearms Ballistic Pathway Interactive Diagram</summary>
Type: infographic
...
??? question "Challenge: Class vs. Individual"
